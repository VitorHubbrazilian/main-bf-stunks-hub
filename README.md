                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy scriptSTUNKS HUB Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
local OrionLib = loadstring(game:HttpGet(("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addons/InterfaceManager.lua")))()

local Window = Fluent:CreateWindow({
    Title = "STUNKS HUB | BY VITOR",
    SubTitle = "Version 2",
    TabWidth = 160,
...
setclipboard("STUNKS HUB Is The Best")
...
Tabs.Main:AddButton({
        Title = "STUNKS HUB Discord Server",
        Description = "Very important",
        Callback = function()
        setclipboard("https://discord.gg/HTyxM8aT")
        end
        })
...
Fluent:Notify({
    Title = "STUNKS HUB",
    Content = "obrigado por usar STUNKS HUB",
    Duration = 8
})
